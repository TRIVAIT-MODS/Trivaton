...
public class ModArmorMaterials {
    public static final RegistryEntry<ArmorMaterial> THIORITE_ARMOR_MATERIAL = registerArmorMaterial("thiorite",
    ...
    public static RegistryEntry<ArmorMaterial> registerArmorMaterial(String name, Supplier<ArmorMaterial> material) {
        return Registry.registerReference(Registries.ARMOR_MATERIAL, Trivaton.id(name), material.get());
    }
}