...
public class GeneratorScreen extends HandledScreen<GeneratorScreenHandler> {
    private static final Identifier GUI_TEXTURE =
            Identifier.of(Trivaton.MOD_ID, "textures/gui/generator/generator_gui.png");
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        context.drawTexture(CIRCUIT_BOARD_TEXTURE, x+19, y+34, 0, 0, 16, 16, 16, 16);
    ...
    private void renderProgressArrow(DrawContext context, int x, int y) {
        if(handler.isCrafting()) {
            context.drawTexture(ARROW_TEXTURE, x + 105, y + 35, 0, 0,
